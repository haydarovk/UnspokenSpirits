...
public class TextTyper : MonoBehaviour
{
    ...
    [SerializeField] private float startDelay = 2.0f; // Задержка перед началом печати
    [SerializeField] private float fadeDuration = 2.0f; // Продолжительность затухания
    ...
    void Awake()
    {
        ...
        textBlocks = new string[]
        {
            ...
            "-900-ая.\n-Что?\n-Будешь жить в 900-ой комнате. Держи,- и вот в моей руке оказывается небольшой английский ключ. " +
            ...
            "Я уже хотел было развернуться и пойти в другое крыло, как мой взгляд зацепился за одинокую дверь в конце, на которой была приклеена синяя наклейка с нужным мне номером.",
